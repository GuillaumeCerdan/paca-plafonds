<?php include_once 'includes/header.php' ?>
  ...
  <!-- Intro Header -->
  <header class="masthead txt-center">
    <div class="intro-body">
      <div class="container">
        <div class="row">
          <div class="disp-flex">
            <div class="margin-blocks-home">
              <div id="left" class="bck-white pdg-block-home">
                <p>kikoo</p>
              </div>
            </div>
            <div class="margin-blocks-home">
              <div id="right" class="bck-white pdg-block-home">
                <p>kikoo</p>
              </div>
            </div>
          </div>
  ...
  <div class="section" id="section-1">
    <div class="txt-align">
      <h1>Bonjour je m'appelle Anne Onyme</h1>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <p>Grayscale is a free Bootstrap theme created by Start Bootstrap. It can be yours right now, simply download the
            template on
